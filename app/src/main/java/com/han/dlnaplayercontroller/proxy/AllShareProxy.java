...
import com.han.dlnaplayercontroller.center.AbstractMediaMng;
import com.han.dlnaplayercontroller.center.DLNAContainer;
import com.han.dlnaplayercontroller.center.MediaServerMng;
import com.han.dlnaplayercontroller.server.DlnaService;
import com.han.dlnaplayercontroller.utils.UpnpUtil;

/**
 * AllShareProxy代理了MediaServerMng类
 */
public class AllShareProxy implements IDeviceOperator,
    ...
    public List<Device> getDMRDeviceList() {
        return dmrContainer.getDevices();
    }
    ...
    public void setDMRSelectedDevice(Device selectedDevice) {
        dmrContainer.setSelectedDevice(selectedDevice);
    }

    public Device getDMRSelectedDevice() {
        return dmrContainer.getSelectedDevice();
    }
